...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body panel-body-nopadding">
            ...
            <form class="form-horizontal form-bordered" action="/admin/ad/save" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                    ...
                    <div class="col-sm-6">
                        <select class="form-control">
                            @if(!empty($position))
                                ...
                                <option value="{{$p['id']}}" @if($info->position_id == $p['id']) selected @endif>{{$p['position_name']}}</option>
                                @endforeach
                            @endif
                        </select>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        ...
                        <img src="{{$info->image_url}}" style="width: 60px;" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">广告名称</label>
                    <div class="col-sm-6">
                        <input type="text" placeholder="广告名称" class="form-control" name="ad_name" value="{{$info->ad_name}}" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">链接地址</label>
                    <div class="col-sm-6">
                        <input type="text" placeholder="链接地址" class="form-control" name="ad_link" value="{{$info->ad_link}}" />
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" placeholder="点击次数" class="form-control" name="clicks" value="{{$info->clicks}}" />
                    </div>
                </div>
                <div class="form-group">
