        ...
        <div class="panel-body panel-body-nopadding" id="attr_add">
            ...
            <form class="form-horizontal form-bordered" action="/admin/goods/attr/save" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="radio"><label><input @click="changeType" data-id="1" type="radio" name="input_type" value="1" {{$info->input_type == 1 ? 'checked' :""}}> 手动录入</label></div>
