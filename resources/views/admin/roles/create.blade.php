        ...
        <div class="panel-body panel-body-nopadding">
          ...
          <form class="form-horizontal form-bordered" action="{{route('admin.role.store')}}" method="post">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text" placeholder="角色名字" class="form-control" name="role_name" value="{{$role->role_name or null}}" />
              </div>
            </div> 
            <div class="form-group">
              <label class="col-sm-3 control-label">角色描述</label>
              <div class="col-sm-6">
                <input type="text" placeholder="角色描述" class="form-control" name="role_desc" value="{{$role->role_desc or null}}"/>
              </div>
            </div> 
